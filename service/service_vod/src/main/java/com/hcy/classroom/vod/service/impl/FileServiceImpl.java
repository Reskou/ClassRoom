...
import com.hcy.classroom.vod.service.FileService;
...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        ...
        String secretId = ConstantYMLUtils.ACCESS_KEY_ID;
        String secretKey = ConstantYMLUtils.ACCESS_KEY_SECRET;
        String endPoint = ConstantYMLUtils.END_POINT;
        COSCredentials cred = new BasicCOSCredentials(secretId, secretKey);
        // 2 设置 bucket 的地域, COS 地域的简称请参照 https://cloud.tencent.com/document/product/436/6224
        // clientConfig 中包含了设置 region, https(默认 http), 超时, 代理等 set 方法, 使用可参见源码或者常见问题 Java SDK 部分。
        Region region = new Region(ConstantYMLUtils.END_POINT);
